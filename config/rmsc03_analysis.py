...
if args.log_dir is None:
    log_dir = "rmsc03_two_hour_" + dt.datetime.now().strftime('%m%dT%H%M%S')
else:
...
for experiment in ['impact', 'no_impact', 'control']:
    # Reinitialize
    ...
    print("Running", experiment, agent_count, "agents")
...
measure = PriceMeasure(log_dir, 'impact', 'no_impact')
result = measure.compare().item()
